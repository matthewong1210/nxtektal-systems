...
| Local service lifecycle, Manager API/projection transport, service health, fixture source-cursor persistence | `nxt_site_agent` (application shell only; loopback-only, noncanonical; fixture composition stays in composition roots) |
