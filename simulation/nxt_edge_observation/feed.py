...
number so published ordering stays contiguous.  Composing that into an
actual ``ObservationSource`` is the composition root's job -- this
package must not import the Site Runtime.
"""
