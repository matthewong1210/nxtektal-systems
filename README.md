...
| `simulation/nxt_agent_runtime/` | Deterministic composition of Site Runtime output through Shadow Ops evaluation, with evaluation checkpoints, journal, and pending manager decisions | Implemented composition layer; fixture-backed sources including the explicitly hybrid local mock-MQTT rehearsal, advisory only |
